...
For instance, `dig @fanfi.cx "[work_id] 17400464 [chapter] 3" -p 1337 +short` is a valid query. 
`dig @fanfi.cx "[search] stag beetles and broken legs" -p 1337 +short` is also a valid query. 
